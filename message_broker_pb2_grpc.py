...
class MessageBrokerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Subscribe = channel.unary_stream(
                ...
                response_deserializer=message__broker__pb2.SubscribeResponse.FromString,
                _registered_method=True)
        self.ValidateConnection = channel.unary_unary(
                '/message_broker.MessageBroker/ValidateConnection',
                request_serializer=message__broker__pb2.ValidateConnectionRequest.SerializeToString,
                response_deserializer=message__broker__pb2.ValidateConnectionResponse.FromString,
                _registered_method=True)
...
def add_MessageBrokerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Subscribe': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=message__broker__pb2.SubscribeResponse.SerializeToString,
            ),
            'ValidateConnection': grpc.unary_unary_rpc_method_handler(
                    servicer.ValidateConnection,
                    request_deserializer=message__broker__pb2.ValidateConnectionRequest.FromString,
                    response_serializer=message__broker__pb2.ValidateConnectionResponse.SerializeToString,
            ),
    }
...
class MessageBroker(object):
    ...
    def Subscribe(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            message__broker__pb2.SubscribeResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def ValidateConnection(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/message_broker.MessageBroker/ValidateConnection',
            message__broker__pb2.ValidateConnectionRequest.SerializeToString,
            message__broker__pb2.ValidateConnectionResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
